...
# Cards
from .cards.views import CardsViewSet, RulesViewSet, TransfersViewSet, TransactionViewSet  # noqa
...
from .chores.views import ChoresViewSet  # noqa
router.register(r'chores', ChoresViewSet, base_name='chores')
